...
const ClassAccess = (clase) => {
  return (
    <Link className="w-full md:w-1/3" href={"/" + clase.clase.DISPLAYLABEL}>
      <div className="p-4">
        <div className="flex rounded-lg h-full w-full bg-gray-100 p-8 flex-col">
          <div className="flex items-center mb-3">
            ...
            <h2 className="text-gray-900 text-lg title-font font-medium">{clase.clase.DISPLAYLABEL}</h2>
          </div>
